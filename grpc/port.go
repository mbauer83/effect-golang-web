...
// UnaryHandler is what a transport calls when a request arrives: the request's
...
// ServerTransport is a transport that answers procedures.
...
// ClientTransport is a transport that invokes a procedure.
//
