...
func Route(
	...
	return web.Upgrading("/tally", "Keep a running tally",
		websocket.Accept(boundary, runConversation(running), websocket.Settings{}))
}
...
func runConversation(running effect.Ref[int64]) func(websocket.Socket) tallyEffect[effect.Unit] {
...
func applyTally(running effect.Ref[int64], change Change) tallyEffect[int64] {
